...
namespace TriangleTest
{
    ...
    public class UnitTestTriangle
    {
        ...
        {
            Result = TriangleSolver.Analyze(5, 15, 15);
        ...
        {
            Result = TriangleSolver.Analyze(5, 5, 5);
        ...
        {
            Result = TriangleSolver.Analyze(7, 12, 15);
        ...
        public void Unit_Test_Of_TwoSide_negative_Triangle()
        {
            ...
            Result = TriangleSolver.Analyze(-3, -2, 15);
            Assert.AreEqual(Result, "Triangle is not valid.");
        }
        ...
        {
            Result = TriangleSolver.Analyze(0, 10, 15);
            Assert.AreEqual(Result, "Triangle is not valid.");
        }
        ...
        {
            Result = TriangleSolver.Analyze(2, 3, 5);
            Assert.AreEqual(Result, "Triangle is not valid.");
        }
